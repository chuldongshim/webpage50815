...
13.10.00 ~ 16.09.00 : A-SPICE 및 ISO26262 통합 프로세스 구축  
14.04.00 ~ 15.03.00 : A-SPICE CL2 신규 프로세스 구축 및 시스템 설계  
15.04.00 ~ 16.03.00 : ISO26262 기능안전 시스템 설계 대응  
19.05.00 ~ 19.12.00 : [A-SPICE CL3 표준 프로세스 고도화 및 프로젝트 관리 ☜ click ](/docs/mycareer/myprocess#a-spice-cl3-%ED%94%84%EB%A1%9C%EC%84%B8%EC%8A%A4)  
21.11.20 ~ 22.03.21 : [KTL(한국기술시험원) MBD교육을 위한 예제 프로젝트 개발 ☜ click ](/docs/mycareer/myprocess#github-%EC%86%8D%EB%8F%84%EC%B8%A1%EC%A0%95-mbd)  
