...
1. 17.06.07~19.04.12 : 열차 출입문 제어기 개발 [☜ click for more]  
...
2. 09.03.16~09.12.18 : 무인 전기자동차 하위 제어기 개발 [☜ click for more]  
...
3. 08.09.01~09.02.26 : 유도인형 제어기 개발 [☜ click for more]  
<p align="left">
	<img
...
1. 10.09.01~11.08.31 : 다축 Force/Torque센서 상용화 기술 개발 [☜ click for more]
<p align="left">
	<img
...
1. 23.05.03~23.xx.xx : Sensorless BLDC by Kalman Filter (TBD) [☜ click for more]  
현재 진행중
2. 22.10.21~22.11.05 : MBD기반 Sensored BLDC 속도제어 [☜ click for more]  
...
4. 16.10.03~17.04.30 : Kalman Filter이론학습(Self_Study) [☜ click for more]  
현대제어 이론 이해 완료
<p align="left">
	<img
...
1. 22.03.03~22.05.17 : PSB(안전벨트) 기능로직 MBD구현 선행개발 고객대응[☜ click for more]  
...
2. 21.11.20~22.03.21 : Escalator를 통한 GitLab Agile기반 MBD 개발 [☜ click for more]  
...
1. 22.09.01~22.10.18 : 와이퍼 MBD 제어기설계(관측기,LQR) [☜ click for more]  
...
2. 22.08.14~22.08.29 : FFT MCU 구현 및 Matlab 연동 확인 [☜ click for more]  
...
3. 21.01.08~21.07.13 : 와이퍼 MBD 기본기능 구현 [☜ click for more]  
Auto Wiping 동작확인
<p align="left">
	<iframe
...
1. 21.07.30~21.12.31 : 윈도우 MBD 기본기능 구현 [☜ click for more]  
...
2. 13.10.01~14.05.16 : 윈도우 MBD 선행학습 [☜ click for more]  
...
1. 20.08.12~20.11.13 : 온도 PID제어 MBD [☜ click for more]  
...
2. 07.03.02~08.08.31 : 졸업논문 DC모터 PID제어[☜ click for more]  
센서 입력에 따른 모터 PID제어  
...
1. 23.09.01~23.xx.xx : Github를 통한 Agile기반 리눅스 프로젝트 일정 및 이슈관리 [☜ click for more]  
Beaglebone Black Linux 플랫폼에서 C++ 기반 IOT 어플리케이션 개발
2. 23.09.01~23.xx.xx : Github를 통한 Agile기반 MBD 프로젝트 일정 및 이슈관리 [☜ click for more]  
Simulink를 이용한 알고리즘 개발
3. 23.02.02~23.04.25 : Github를 통한 Agile기반 임베디드 프로젝트 일정 및 이슈관리 [☜ click for more]  
...
1. 22.12.02~22.12.26 : A-SPICE를 준수하는 소프트웨어 컴포넌트 MBD개발 프로세스 구축 [☜ click for more]  
...
2. 19.11.14~20.05.31 : A-SPICE 대응 선루프 시스템 설계 [☜ click for more]
<p align="left">
	<img
...
3. 19.05.20~19.12.10 : 프로젝트 관리 및 A-SPICE CL3 인증 [☜ click for more]
<p align="left">
	<img
...
4. 14.04.01~16.09.20 : A-SPICE CL2 인증 및 ISO26262 윈도우 시스템 설계 [☜ click for more]
<p align="left">
	<img
...
1. 19.09.10~20.09.10 : AWS Cloud를 통한 Redmine 환경구축 [☜ click for more]  
...
2. 18.01.18~18.08.12 : Redmine을 통한 열차출입문제어기SW 품질이슈 관리 [☜ click for more]
<p align="left">
	<img
