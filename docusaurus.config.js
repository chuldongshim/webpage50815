    ...
    [
      ...
      /** @type {import('@docusaurus/preset-classic').Options} */
      {
        docs: {
          ...
          editUrl: 'https://github.com/chuldongshim/webpage50208/',
        },
        blog: {
          showReadingTime: true,
          // Please change this to your repo.
          editUrl:
            'https://github.com/chuldongshim/webpage50208/tree/main/docs',
        },
        theme: {
    ...
    /** @type {import('@docusaurus/preset-classic').ThemeConfig} */
    {
      ...
      navbar: {
        ...
        /*{
          ...
          {
            href: 'https://github.com/chuldongshim/webpage50208/',
            label: 'MyGitHub',
            position: 'right',
          },
        ],
